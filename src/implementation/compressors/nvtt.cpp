...
static nvtt::Format to_nvtt_enum(uimg::TextureInfo::OutputFormat format)
{
	...
	static_assert(umath::to_integral(uimg::TextureInfo::OutputFormat::Count) == 20);
	return {};
}
...
std::optional<uimg::ITextureCompressor::ResultData> uimg::NvttTextureCompressor::Compress(const CompressInfo &compressInfo)
{
...
std::unique_ptr<uimg::ITextureCompressor> uimg::NvttTextureCompressor::Create() { return std::make_unique<NvttTextureCompressor>(); }
