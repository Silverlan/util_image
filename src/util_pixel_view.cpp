...
uimg::ImageBuffer::PixelView::PixelView(ImageBuffer &imgBuffer,Offset offset)
...
uimg::ImageBuffer::PixelIterator::PixelIterator(ImageBuffer &imgBuffer,Offset offset)
...
uimg::ImageBuffer::PixelView *uimg::ImageBuffer::PixelIterator::operator->() {return &m_pixelView;}
bool uimg::ImageBuffer::PixelIterator::operator==(const PixelIterator &other) const
{
